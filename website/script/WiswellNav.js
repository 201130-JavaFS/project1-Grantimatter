...
let openWindow = function(url, newWindow = false){
    window.open(url, newWindow ? "_blank" : "_self");
}

let isLoggedIn = false;

let nav = new Navbar("Wiswell", ()=>openWindow("../pages/home.html"));
nav.addLeftListItem("Home", ()=>openWindow("../pages/home.html"));
nav.addLeftListItem("Reimbursements", ()=>openWindow("../pages/reimbursements.html"));

if(!isLoggedIn){
    nav.addRightListItem("Login", ()=>openWindow("../pages/login.html"));
}else{
    nav.addRightListItem("Logout", ()=>openWindow("https://www.google.com", true));
}
