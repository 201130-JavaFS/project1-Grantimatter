...
let nav = new Navbar("Wiswell", "/project-1/home");
nav.addLeftListItem("Home", "/project-1/home");
nav.addLeftListItem("Reimbursements", "/project-1/reimbursements");

if(!isLoggedIn){
    nav.addRightListItem("Login", "/project-1/login");
}else{
