...
public class ReimbursementQueries {
    // QUERIES
    public static final String GET_REIMBURSEMENT_DATA = "SELECT r.reimb_id, r.reimb_amount, r.reimb_author, r.reimb_type_id, r.reimb_description, r.reimb_status_id, r.reimb_submitted FROM ers_reimbursement AS r ";
    ...
    public static final String APPROVE_REIMBURSEMENT = "UPDATE ers_reimbursement SET reimb_status_id=1 WHERE reimb_id=?";
    public static final String DENY_REIMBURSEMENT = "UPDATE ers_reimbursement SET reimb_status_id=2 WHERE reimb_id=?";
}
